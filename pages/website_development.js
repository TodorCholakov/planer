...
export default function Contact() {
  ...
  return (
     ...
     <div className="flex justify-center">
      ...
      <div className="card glass max-w-7xl  mt-2 mb-20">
       ...
       <div>
        ...
        Design that 
          ...
          <Image width="100" height="100" src="/logo.png" alt="Shoes" className="mt-4"/>
  
          <h1>That's why Click here. Tell us what you need and </h1>
