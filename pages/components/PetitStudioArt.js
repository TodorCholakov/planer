          ...
          <CardBody>
            <p className="text-left">
              <span className="text-xl text-gray-600">
                ...
                fast, cost-effective websites and applications
                tailored precisely to your requirements. Our commitment to
                excellence is in every project, thanks to our
                passionate team of designers and developers. Whether you're
                looking for a striking portfolio website, a cutting-edge
                application with bespoke features, an event website that stands
                out, or any other digital solution, we've got you covered.
              </span>
